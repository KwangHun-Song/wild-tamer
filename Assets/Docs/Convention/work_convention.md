...
각 시스템은 아래 6단계를 순서대로 진행한다. 각 단계의 산출물은 해당 시스템 폴더에 저장한다.
...
컨셉/설계 문서를 **검증**한다. 리뷰 컨벤션(`review_convention.md`)에 따라 진행한다.

- 컨벤션 충족도 검증
- 긍정적인 점 및 개선 제안 기술
- 중요도(높음/중간/낮음) 표기
- 종합 평가 및 우선 보강 사항 정리
- 높음 이슈는 반영 후 다음 단계 진행

### 4단계: 구현 계획 문서 (`implementation_plan.md`)
